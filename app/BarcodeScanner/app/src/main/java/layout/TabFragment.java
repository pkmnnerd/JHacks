...
public class TabFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("tweets").setIndicator("Tweets"),
                TweetsFragment.class, null);
        mTabHost.addTab(mTabHost.newTabSpec("recommended").setIndicator("Recommended"),
                RecommendedFragment.class, null);
